...
const PresentationSection: React.FC = () => {
  ...
  return (
    <section id="home" className="relative w-full min-h-screen flex flex-col items-center justify-start overflow-hidden bg-light">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
         <svg viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice" className="w-full h-full text-secondary fill-current">
            <defs>
               ...
               <linearGradient id="wheelLeather" x1="0%" y1="0%" x2="100%" y2="100%">
               ...
               <linearGradient id="wheelRimHighlight" x1="50%" y1="0%" x2="50%" y2="100%">
                 <stop offset="0%" stopColor="#78716C" stopOpacity="0.8" /> {/* Stone 500 */}
            ...
            <g id="Mountains" transform="translate(0, 50)" opacity="0.3">
               {/* Back Range */}
               <path d="M0,600 L200,300 L400,550 L600,250 L800,500 L1100,200 L1400,550 L1700,300 L1920,500 L1920,700 L0,700 Z" fill="#8B5E3C" opacity="0.5" />
               {/* Front Range */}
               <path d="M0,700 L300,500 L500,650 L800,450 L1100,680 L1400,480 L1600,650 L1920,500 L1920,700 L0,700 Z" fill="#1F2937" opacity="0.4" />
            </g>
            ...
            <g id="Birds" opacity="0.7">
                <g className="hidden md:block">
                    <g transform="translate(350, 250)">
                        <path d="M0,10 Q10,0 20,10 M20,10 Q30,0 40,10" fill="none" stroke="#1F2937" strokeWidth="2.5" className="bird-anim-1" />
                        <path d="M-40,30 Q-30,20 -20,30 M-20,30 Q-10,20 0,30" fill="none" stroke="#1F2937" strokeWidth="2" className="bird-anim-2" transform="scale(0.8)" />
                        <path d="M30,-20 Q40,-30 50,-20 M50,-20 Q60,-30 70,-20" fill="none" stroke="#1F2937" strokeWidth="2" className="bird-anim-3" transform="scale(0.7)" />
                    </g>
                    <g transform="translate(1500, 200)">
                        <path d="M0,10 Q12,0 24,10 M24,10 Q36,0 48,10" fill="none" stroke="#1F2937" strokeWidth="2.5" className="bird-anim-2" />
                        <path d="M60,-10 Q70,-20 80,-10 M80,-10 Q90,-20 100,-10" fill="none" stroke="#1F2937" strokeWidth="2" className="bird-anim-1" transform="scale(0.8)" />
                    </g>
                </g>
            ...
            <g id="Road">
               {/* Main Asphalt - Darker */}
               <path d="M960,600 L-100,1080 L2020,1080 Z" fill="url(#roadGradient)" opacity="0.9" />
               
               {/* Side Lines */}
               <path d="M960,600 L150,1080" stroke="#FFFFFF" strokeWidth="4" opacity="0.8"/>
               <path d="M960,600 L1770,1080" stroke="#FFFFFF" strokeWidth="4" opacity="0.8"/>
            ...
            {/* PASSING OBJECTS */}
            <g id="PassingSign" className={`sign-passing ${isSignActive ? 'active' : ''}`}>
                <rect x="-4" y="-140" width="8" height="140" fill="url(#poleGradient)" />
                
                {signType === 'circle' ? (
                  <g>
                    <circle cx="0" cy="-140" r="35" fill="#FFFFFF" stroke="#B91C1C" strokeWidth="8" />
                    <text x="0" y="-128" textAnchor="middle" fill="#000000" fontSize="30" fontWeight="bold" fontFamily="sans-serif" letterSpacing="-1">
                      {signContent}
                    </text>
                  </g>
                ) : (
                  <g transform="translate(0, -145)">
                     <path d="M0,-40 L42,35 L-42,35 Z" fill="#FFFFFF" stroke="#B91C1C" strokeWidth="8" strokeLinejoin="round" />
                     {signContent === 'narrow' ? (
                        ...
                        <g>
                           <rect x="-3" y="-15" width="6" height="25" rx="1" fill="#000000" />
                           <circle cx="0" cy="20" r="3" fill="#000000" />
                        </g>
                     )}
                  </g>
                )}
                <ellipse cx="-15" cy="-160" rx="10" ry="5" fill="#FFFFFF" opacity="0.3" transform="rotate(-45 -15 -160)" />
            </g>
            ...
            <g id="Dashboard" className="dashboard-placement">
               <g className="cabin-vibration">
                   ...
                   <path d="M-100,800 Q960,700 2020,800 L2020,1080 L-100,1080 Z" fill="#44403C" opacity="0.6" />
                   <path d="M-100,810 Q960,710 2020,810" stroke="#A69F91" strokeWidth="1" fill="none" opacity="0.2" />
                   
                   {/* DIGITAL CLUSTER */}
                   <g id="DigitalCluster" transform="translate(960, 770)" className="digital-glow">
                      <path d="M-280,0 Q0,-50 280,0 L250,150 Q0,120 -250,150 Z" fill="#000000" opacity="0.6" />
                      <path d="M-280,0 Q0,-50 280,0 L250,150 Q0,120 -250,150 Z" fill="none" stroke="#A69F91" strokeWidth="1" opacity="0.3" />

                      {/* 1. CENTER GAUGE (Speed) */}
                      <g id="GaugeCenter">
                          <circle cx="0" cy="60" r="105" fill="none" stroke="#CFFAFE" strokeWidth="1" opacity="0.3" />
                          <path d="M-75,90 A85,85 0 1,1 75,90" fill="none" stroke="#CFFAFE" strokeWidth="8" opacity="0.1" strokeLinecap="round" />
                          <circle cx="0" cy="60" r="95" fill="none" stroke="#CFFAFE" strokeWidth="4" opacity="0.2" strokeDasharray="2 8" />
                          <path 
                            ...
                            opacity="0.9"
                          />
                          <text x="0" y="70" textAnchor="middle" fill="#CFFAFE" fontSize="65" fontWeight="bold" fontFamily="monospace" opacity="0.95" letterSpacing="-2">
                            {speed}
                          </text>
                      ...
                      <g id="GaugeRight" transform="translate(190, 50)">
                          ...
                          <circle cx="0" cy="0" r="54" fill="none" stroke="#CFFAFE" strokeWidth="6" opacity="0.1" strokeDasharray="240 400" transform="rotate(135)" strokeLinecap="round" />
                          <circle cx="0" cy="0" r="54" fill="none" stroke="#CFFAFE" strokeWidth="6" opacity="0.1" strokeDasharray="2 6" transform="rotate(135)" strokeLinecap="round" />
                          <circle cx="0" cy="0" r="54" fill="none" stroke="#CFFAFE" strokeWidth="6" opacity="0.9" strokeDasharray="100 400" transform="rotate(135)" strokeLinecap="round" />
                          <text x="0" y="5" textAnchor="middle" fill="#CFFAFE" fontSize="16" fontWeight="bold" opacity="0.9">2.5</text>
                          <text x="0" y="20" textAnchor="middle" fill="#CFFAFE" fontSize="10" opacity="0.7">x1000</text>
                      </g>
                   </g>
               </g>
            </g>
            ...
            <g className="cabin-vibration">
                <g className="driving-animation">
                    ...
                    <g id="Steering_wheel" className="wheel-placement" filter="url(#shadow)">
                       {/* Column behind wheel - Warmer */}
                       <path d="M-40,-50 L40,-50 L60,150 L-60,150 Z" fill="#292524" />

                       {/* Wheel Rim */}
                       <ellipse cx="0" cy="0" rx="340" ry="290" stroke="url(#wheelLeather)" strokeWidth="60" fill="none" />
                       <ellipse cx="0" cy="0" rx="340" ry="290" stroke="url(#wheelRimHighlight)" strokeWidth="50" fill="none" style={{mixBlendMode: 'overlay'}} />
                       <ellipse cx="0" cy="0" rx="315" ry="265" stroke="#000" strokeWidth="2" fill="none" opacity="0.3" />
                       ...
                       {/* Center Hub */}
                       <path d="M-120,20 L120,20 L80,120 L-80,120 Z" fill="url(#hubGradient)" />
                       
                       {/* Spokes */}
                       <path d="M-290,10 L-120,20 L-80,90 L-250,150 Z" fill="url(#wheelLeather)" />
                       <path d="M290,10 L120,20 L80,90 L250,150 Z" fill="url(#wheelLeather)" />
                       <path d="M-60,110 L-50,285 L50,285 L60,110 Z" fill="url(#wheelLeather)" />

                       {/* Center Horn/Airbag */}
                       <ellipse cx="0" cy="50" rx="90" ry="70" fill="url(#wheelLeather)" stroke="#2D3748" strokeWidth="1"/>
                       ...
                       <g transform="translate(-290, -120) rotate(-20)"> 
                           <rect x="-25" y="-30" width="50" height="60" rx="10" fill="#292524" stroke="#000" strokeWidth="2" />
                           <circle cx="0" cy="0" r="15" fill="#B91C1C" stroke="#7F1D1D" strokeWidth="2">
                               <animate attributeName="fill" values="#B91C1C;#EF4444;#B91C1C" dur="2s" repeatCount="indefinite" />
                           </circle>
                       ...
                       <g transform="translate(290, -120) rotate(20)">
                           ...
                           <text x="0" y="5" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">R</text>
                       </g>
